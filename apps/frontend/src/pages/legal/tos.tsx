		...
		>
			...
			<ul>
				...
				<li>
					...
					&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to BuildTheEarth.
				</li>
				<li>
				...
				<li>
					...
					posted, uploaded, linked to or otherwise made available by You, regardless of the form of that content.
				</li>
				<li>
				...
				<li>
					<strong>&quot;Terms and Conditions&quot;</strong> (also referred as &quot;Terms&quot; or &quot;Terms of
					Use&quot;) mean these Terms and Conditions that form the entire agreement between You and the Company
					regarding the use of the Service.
				</li>
				<li>
					<strong>&quot;Third-party Social Media Service&quot;</strong> means any services or content (including data,
					information, products or services) provided by a third-party that may be displayed, included or made available
					by the Service.
				</li>
				<li>
					<strong>&quot;Website&quot;</strong> refers to buildtheearth.net, accessible from{' '}
					<Anchor href="https://buildtheearth.net">https://buildtheearth.net</Anchor>, and any subdomain of this domain.
				</li>
				<li>
			...
			<p>
				...
				submit Your notice in writing to the attention of Us via email (business@buildtheearth.net) and include in Your
			...
			<p>
				You can contact Us via email (business@buildtheearth.net). Upon receipt of a notification, the Company will take
				whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from
				the Service.
			</p>
			...
			<ul>
				<li>
					...
					<Anchor href="https://buildtheearth.net/contact">https://buildtheearth.net/contact</Anchor>
				</li>
