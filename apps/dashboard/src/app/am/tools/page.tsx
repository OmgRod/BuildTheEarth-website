		...
		<Box mx="md" maw="90vw">
			...
			<ActionsCard
				...
				links={[
					...
					{ title: 'Pterodactyl Network', icon: IconServer, color: 'pink', url: 'https://network.buildtheearth.net/' },
			...
			<ActionsCard
				...
				links={[
					...
					{ title: 'Maven Repository', icon: IconFolders, color: 'indigo', url: 'https://maven.buildtheearth.net/#/' },
